...
#     include "CMN_SIZE"             ! Size parameters
      ...
      ! Parameters for North America smaller domain
      OUTDATA(1:IIPAR,1:JJPAR,1) = INDATA( 82:172, 207:295,1)

#elif defined( GRID05x0666 ) && defined( NESTED_CH ) && defined( NESTED_SD )

      ! Parameters for China smaller domain
      OUTDATA(1:IIPAR,1:JJPAR,1) = INDATA( 376:496, 181:281, 1)
...
#     include "CMN_SIZE"             ! Size parameters
      ...
      OUTDATA(1:IIPAR,1:JJPAR) = INDATA( 376:496, 181:281, 1)
...
!$OMP END PARALLEL DO
      ...
      ! Parameters for CH smaller domain
      OUTNEST(1:IIPAR,1:JJPAR,1:L1) = OUT_05x06( 376:496, 181:281,1:L1)
