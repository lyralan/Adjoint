         ...
         ct4db= (/3, I1x1, J1x1, 24/)
           ...
           WRITE( 6, 100 )  TRIM(FILENAMEWEC3 ), SId
             ...
             !            st3d,  ct3d )        !Start and Count lat/lon/time
               ...
               !TEST to print out the Species name
               WRITE(*,100) TRIM(SId), SId
            ...
            ! Open and read model_ready data from netCDF file - wkend
               CALL Ncop_Rd(fId2, TRIM(FILENAMEWE))
            ! Open and read ptipm data from netCDF file - wkend
               CALL Ncop_Rd(fId2b, TRIM(FILENAMEWEPT))
            ! Open and read ptnonipm data from netCDF file - wkend
               CALL Ncop_Rd(fId2c, TRIM(FILENAMEWEPTN))
            ! Open and read c3marine data from netCDF file - wkend
            ...
            ENDIF
             ...
             DO L=1,3
              DO HH=1,24  ! check on whether this is correct
                ...
                !ADD SO4 to VOC Category
                CASE ('SO4','BENZ','TOLU','XYLE','RCHO','CH2O','ALD2','C2H6','PRPE','ALK4')
