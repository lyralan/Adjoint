...
!TEST to print out the file name MEGAN_AEF_ISOP.updated_200708.geos.1x1
      WRITE( *, 100 ) TRIM( FILENAME )
!TEST to print out the last converted number in matrix AEF_ISOP
      WRITE( *, *) AEF_ISOP(IIPAR,JJPAR)
...
!TEST to print out the file name MEGAN_AEF_MTP.geos.1x1
      WRITE( *, 100 ) TRIM( FILENAME )
!TEST to print out the last converted number in matrix AEF_MONOT
      WRITE( *, *) AEF_MONOT(IIPAR,JJPAR)
     ...
     &                    INGRID,     OUTGRID, IS_MASS=0 )
      ...
      DO J = 1, JJPAR
         ...
         DO I = 1, IIPAR
            ...
            ! Convert AEF_MBO to [kg C/box/step]
            AEF_MBO(I,J) = AEF_MBO(I,J) * FACTOR

         ENDDO
      ENDDO

!TEST to print out the file name MEGAN_AEF_MBO.geos.1x1
      WRITE( *, 100 ) TRIM( FILENAME )
!TEST to print out the last converted number in matrix AEF_MBO
      WRITE( *, *) AEF_MBO(IIPAR,JJPAR)
...
!TEST to print out the file name MEGAN_AEF_OVC.geos.1x1
      WRITE( *, 100 ) TRIM( FILENAME )
!TEST to print out the last converted number in matrix AEF_OVOC
      WRITE( *, *) AEF_OVOC(IIPAR,JJPAR)
...
100   FORMAT( '     - GET_AEF: Reading ', a )
     ...
     &                 1,         ARRAY,     QUIET=.TRUE. )
      ...
      ! 1x1 file name
      FILENAME = TRIM( DATA_DIR ) //
     &           'MEGAN_200510/MEGAN_AEF_OVC.geos.05x0666'
