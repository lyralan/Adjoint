...
!$OMP+PRIVATE( I,    J,   N,   NN )
     ...
     &                     * CHK_STT(I,J,1,NN)
     &                     * POP_REDUCED(I,J) * 1d9 / AIRVOL(I,J,1)
...
!      FACTORR  = 1d0 / ( POP_TOT * NSPAN ) * N_TOT
      FACTORR  = 1d0 / ( NSPAN ) * N_TOT
...
!     &                        * FACTORR
         ...
         ADJ_FORCE(I,J,1,NN)  = GET_CF_REGION(I,J,1) * POP_REDUCED(I,J)
     &                          * 1d9 / AIRVOL(I,J,1) * FACTORR
...
!      &             'world_population.' // GET_RES_EXT()
       FNAME = '/net/d05/data/rlan/gcadj_std/' // 
     &             'urban_' // GET_RES_EXT() 
